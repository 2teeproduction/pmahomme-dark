...
fieldset, .preview_sql {
	...
	padding: 0.5em;
	background: #383c42;
	text-shadow: <?php echo $GLOBALS['text_dir'] === 'rtl' ? '-' : ''; ?>1px 1px 2px #2b2b2b inset;
	-moz-box-shadow: <?php echo $GLOBALS['text_dir'] === 'rtl' ? '-' : ''; ?>1px 1px 2px #2b2b2b inset;
	-webkit-box-shadow: <?php echo $GLOBALS['text_dir'] === 'rtl' ? '-' : ''; ?>1px 1px 2px #2b2b2b inset;
	box-shadow: <?php echo $GLOBALS['text_dir'] === 'rtl' ? '-' : ''; ?>1px 1px 2px #2b2b2b inset;
}
...
fieldset legend {
	...
	-moz-box-shadow: <?php echo $GLOBALS['text_dir'] === 'rtl' ? '-' : ''; ?>3px 3px 15px #212121;
	-webkit-box-shadow: <?php echo $GLOBALS['text_dir'] === 'rtl' ? '-' : ''; ?>3px 3px 15px #212121;
	box-shadow: <?php echo $GLOBALS['text_dir'] === 'rtl' ? '-' : ''; ?>3px 3px 15px #212121;
	max-width: 100%;
}
...
#topmenu .error {
	background: #eee;border: 0 !important;color: #868687;
}
...
ul#topmenu ul {
	-moz-box-shadow: <?php echo $GLOBALS['text_dir'] === 'rtl' ? '-' : ''; ?>1px 1px 6px #026bb3;
	-webkit-box-shadow: <?php echo $GLOBALS['text_dir'] === 'rtl' ? '-' : ''; ?>2px 2px 3px #026bb3;
	box-shadow: <?php echo $GLOBALS['text_dir'] === 'rtl' ? '-' : ''; ?>2px 2px 3px #026bb3;
}
...
.group {
	...
	-webkit-border-radius: 4px;
	border-radius: 4px;
	-moz-box-shadow: <?php echo $GLOBALS['text_dir'] === 'rtl' ? '-' : ''; ?>2px 2px 5px #121213;
	-webkit-box-shadow: <?php echo $GLOBALS['text_dir'] === 'rtl' ? '-' : ''; ?>2px 2px 5px #121213;
	box-shadow: <?php echo $GLOBALS['text_dir'] === 'rtl' ? '-' : ''; ?>2px 2px 5px #121213;
	margin-bottom: 1em;
	padding-bottom: 1em;
}
...
.ajax_notification {
	...
	-moz-border-radius: 5px;
	-webkit-border-radius: 5px;
	box-shadow: 0 5px 90px #060606;
	-moz-box-shadow: 0 5px 90px #060606;
	-webkit-box-shadow: 0 5px 90px #060606;
}
...
#pma_console .toolbar.collapsed:not(:hover) {
	...
	border-<?php echo $right; ?>: solid 1px #868687;
}
